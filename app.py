...
def main():
    ...
    st.write("Please upload an image of any of these human activities: 'calling', 'clapping', 'cycling', 'dancing', 'drinking', 'eating','fighting', 'hugging', 'laughing', 'listening_to_music', 'running','sitting', 'sleeping', 'texting', 'using_laptop'")
